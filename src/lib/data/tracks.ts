...
export interface Track {
	...
	label: string;
	headline: string;
	/** Hero line, 20 words max. */
	pitch: string;
	/** Long CV summary, used for meta descriptions. */
	summary: string;
...
export const tracks: Track[] = [
	{
		...
		pitch:
			'Software engineer across backend, mobile and applied ML. Six internships, 1st and 2nd place hackathon projects, graduating 2027.',
		summary:
		...
		featured: ['atlas', 'healthica', 'fraud-detection', 'roast-master', 'zeroclip'],
	...
	},
	{
		...
		pitch:
			'Backend engineer: real-time messaging on Supabase, a LLaMA-70B pipeline on Azure, and Dockerized FastAPI services.',
		summary:
		...
		featured: ['fraud-detection', 'risk-ai', 'roast-master', 'atlas', 'logistics-optimizer'],
	...
	},
	{
		...
		pitch:
			'Applied ML engineer: explainable fraud detection with SHAP and Gemini, on-device glucose prediction, and LLM pipelines in production.',
		summary:
		...
		featured: ['fraud-detection', 'healthica', 'atlas', 'musebridge', 'image-captioning'],
	...
	},
	{
		...
		pitch:
			'Flutter and Kotlin engineer. Led an intern team at Link Development, shipped apps at DEPI, taught Flutter to 15+ students.',
		summary:
		...
		featured: ['healthica', 'atlas', 'yourgympal', 'roast-master', 'fraud-detection'],
	...
	},
	{
		...
		pitch:
			'Frontend and full-stack engineer building SvelteKit and React apps, from real-time dashboards to serverless AI apps.',
		summary:
		...
		featured: ['roast-master', 'risk-ai', 'fraud-detection', 'webgl-game', 'healthica'],
		skillOrder: ['Frameworks', 'Languages', 'Cloud & DevOps', 'Data & ML']
	},
	{
		id: 'systems',
		...
		pitch:
			'Engineer who likes working close to the OS: Rust, C++ and Linux, from a zero-copy game clipper to SDN controllers.',
		summary:
